...
from training.mode.model import GenerativeType, ModelMeanType, ModelType, ModelVarType
from training.models import Model
from training.models.nn import mean_flat
...
class GaussianDiffusionBeatGans:
    ...
    def training_losses(self, model: Model, x_start: torch.Tensor, t: torch.Tensor, model_kwargs=None, noise: torch.Tensor = None):
        """
    ...
    def sample(self, model: Model, shape=None, noise=None, cond=None, x_start=None, clip_denoised=True, model_kwargs=None, progress=False):
        ...
        if self.conf.gen_type == GenerativeType.ddpm:
            return self.p_sample_loop(
                model, shape=shape, noise=noise, clip_denoised=clip_denoised, model_kwargs=model_kwargs, progress=progress
            )
